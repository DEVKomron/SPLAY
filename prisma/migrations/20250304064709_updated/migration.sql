/*
  ...
  - Made the column `userId` on table `Devices` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Devices" ALTER COLUMN "userId" SET NOT NULL;
